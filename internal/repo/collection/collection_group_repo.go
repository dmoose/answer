...
// Collection groups are identity-global like the collections they hold: one
// bookmark list per person across every sub-site, so nothing here is
// site-scoped and site_id is never stamped.
