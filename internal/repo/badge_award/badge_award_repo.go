...
// Badge awards are identity-global: achievements belong to the person, not a
// sub-site, so reads and writes are deliberately un-scoped (one achievement
// set per user, visible from every sub-site).
